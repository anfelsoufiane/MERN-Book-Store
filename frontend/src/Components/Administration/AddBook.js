...
function AddBook(){
    ...
    async function addBook(e){
        ...
        await axios.post("https://api.cloudinary.com/v1_1/ddipjb11c/image/upload", formData)
            .then(async (res)=> {
                const book={"name":name, "description":description, "price":price, "category":Categories[selectedCat], 
    ...
    return (
        ...
        <Form onSubmit={(e)=> addBook(e)}>
            <Form.Group className="mb-3">
                ...
                <Form.Control type="text" value={isbn} placeholder="ISBN du Livre" onChange={(e)=>setIsbn(e.target.value)} required/>
            </Form.Group>
            <Form.Group className="mb-3">
                <Form.Label>Nom</Form.Label>
                <Form.Control type="text" value={name} placeholder="Nom du Livre" onChange={(e)=>setNom(e.target.value)} required/>
            </Form.Group>
            <Form.Group className="mb-3">
            ...
            <Form.Group className="mb-3">
                ...
                <Form.Control type="number" value={price} placeholder="Prix du Livre" onChange={(e)=>setPrix(e.target.value)} required/>
            </Form.Group>
            <Form.Group className="mb-3">
            ...
            <Form.Group className="mb-3">
                ...
                <Form.Control type="file" placeholder="image du Livre" accept="image/png, image/jpeg, image/jpg" onChange={(e)=>setImage(e.target.files[0])}/>
            </Form.Group>
            <Button className="mb-3" variant="primary" type="submit"> Ajouter </Button>
        </Form>
        </div>
    </>
    )
